gmt begin map-out/Xuchang-alone-in-Henan-JM png,pdf
    gmt set MAP_GRID_PEN_PRIMARY gray,12_12
    @REM 绘制河南省界，省会，黄河，标红许昌市界
    ...
    gmt plot Henan-border-L1.dat -W1.0p
    gmt plot Xuchang-border-L1.dat -W2.5p,red
    echo 113.65 34.76 | gmt plot -Sc0.8c -Gblack
    echo 113.65 34.76 ML 郑州 | gmt plot -Sc1.5c -W2p,black
